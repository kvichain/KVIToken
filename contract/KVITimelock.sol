 ...
 */
contract KVITokenTimelock is Ownable{
    // PSCToken contract being held
    KVIToken private _token;
    ...
    constructor (KVIToken token, address beneficiary, uint256 releaseTime) public {
     ...
     */
    function token() public view returns (KVIToken) {
        return _token;
    }
